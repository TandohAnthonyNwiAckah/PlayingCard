...
/**NB  @IBDesignable provides functionality for live rendering of changes of our custom views directly in a Storyboard or .xib.
 *All we have to do is mark the class of a custom view with a @IBDesignable attribute and implement the prepareForInterfaceBuilder() method.
 * NB @IBInspectable allows us to create attributes in code that we can assign in a storyboard or a .xib file.
 * For example, when we want a cornerRadius *property available in a Storyboard, we create a cornerRadius property inside our custom view
 * and mark it with @IBInspectable.
 */
...
class PlayingCardView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if isFaceUp {
            ...
            if let cardBackImage = UIImage(named: "tanacom", in: Bundle(for: self.classForCoder), compatibleWith: traitCollection) {
